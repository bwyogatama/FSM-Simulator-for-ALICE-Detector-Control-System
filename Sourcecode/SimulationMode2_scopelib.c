//Scopelib script for SimulationMode2.pnl

global dyn_dyn_string statepernode,fulldata,fulldatapoint,treshold;
global bool work,suspiciousloop,done,isLoop;
global dyn_string workcombi;
global int globalCounter,counterloop,count_suspicious,suspiciousnum,multi;
global ulong count_combination;
global dyn_int count,count2,x;
global float delay1,delay2;
